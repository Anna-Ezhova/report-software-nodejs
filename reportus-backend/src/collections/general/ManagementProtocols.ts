...
import { Admin, ManagementandAdmin, addUser, allUsers } from '../accessPolicies/accessPolicies'
import { DEPARTMENT_DATA } from '../../config'

const ManagementProtocol: CollectionConfig = {
  slug: 'management_protocols',
  access: {
...
export default ManagementProtocol
